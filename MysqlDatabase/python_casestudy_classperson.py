# Q2.B Define class person.Derive two classes employee and student from class person and derive two classes lab assistant and faculty from employee.
...
stud1 = Student("Pooja Pradeep Deokar","25-09-2002","COMPUTER",2030331245029,"SECOND YEAR",8.75)
stud2 = Student("Sneha Sanjay Tembe","08-08-2003","COMPUTER",2030331245053,"SECOND YEAR",8.75)
stud3 = Student("Trupti Santosh Mahabale","19-08-2002","COMPUTER",2030331245055,"SECOND YEAR",8.80)
stud4 = Student("Shravani Vilas Chavan","18-08-2002","COMPUTER",2030331245063,"SECOND YEAR",9.0)


stud5 = Student("Sanika Patil","20-01-1999","IT",2130331246504,"SECOND YEAR",7)
stud6 = Student("Aditi Ambawale","03-07-2001","IT",2130331265503,"SECOND YEAR",8)
stud7 = Student("Raj Naike","02-12-2000","IT",2130331246502,"SECOND YEAR",8)
